...
export function extractConfigurationsFromAgent({
  ...
  console.log(`Extracting configurations for agent ${agent.assistant_id} (${agent.name}):`, {
  ...
  const configToolsWithDefaults = toolConfig.map((f) => {
    ...
    console.log(`Tools config for field ${f.label}:`, {
      configurable: configurable[f.label],
      fieldDefault: f.default,
      finalDefault: defaultConfig
    });
    return {
      ...f,
      default: defaultConfig
    ...
    ? {
        ...
        default: {
          ...
          max_entity_tokens:
            ...
            ragConfig.default?.max_entity_tokens ??
            4000,
          max_relation_tokens:
            (
              configurable[
            ...
            ragConfig.default?.max_relation_tokens ??
            4000,
          min_rerank_score:
            (
              configurable[
            ...
            ragConfig.default?.min_rerank_score ??
            0.0,
          rag_url:
